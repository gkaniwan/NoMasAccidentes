...
<head>
  ...
  <title>No Mas Accidentes | Mantenedor Accidentes</title>
...
<!--       <li class="nav-item dropdown">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mantenedor Accidentes</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="inicioAdmin.php">Inicio</a></li>
              <li class="breadcrumb-item active">Mantenedor Accidentes</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <?php include('modalActualizarAccidente.php');?>
  <?php include('modalNuevoAccidente.php');?>
