              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="IdUsuario" placeholder="Rut Cliente" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="rutClienteModificar" class="col-sm-2 col-form-label">Rut Usuario</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-contro" id="selectRolUsuarioModificar">
