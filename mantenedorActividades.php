            ...
            <div class="card">
              <div class="card-header border-0">
                ...
                <div class="card-tools">
                  <button type="button" class="btn btn-sm btn-block btn-outline-success" onclick="verCrearActividades();">Agregar</button>
                </div>
                ...
                <table class="table table-striped table-valign-middle">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>05-04-2020</td>
                      <td>Visita</td>
                      <td>Visita 1 a Cliente 1 </td>
                      <td>
                        <button type="button" class="btn btn-sm btn-block btn-outline-warning" onclick="verActualizarActividades();">Modificar</button>
                      </td>
                      <td>
...
<script>
  ...
  function verActualizarActividades(){

    $('#modalActualizarActividad').modal('show');

  }

    function verCrearActividades(){
